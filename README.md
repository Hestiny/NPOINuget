...
<root>
  ...
  ├── Editor
  │   ├── norlo.Npoinuget.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── norlo.Npoinuget.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── norlo.Npoinuget.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── norlo.Npoinuget.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `norlo.Npoinuget`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package NPOINuget Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/norlo.Npoinuget.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/norlo.Npoinuget.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/norlo.Npoinuget.Editor.Tests.asmdef`

  `Tests/Runtime/norlo.Npoinuget.Tests.asmdef`
...
Use the `Documentations~/NPOINuget.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
